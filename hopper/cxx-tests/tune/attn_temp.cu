...
void benchmark(const char* dtype_name, const RunOptions& options) {
  ...
  const double time_ms = total_ms / 200;
...
int main(int argc, char** argv) {
  ...
  benchmark<cute::float_e4m3_t, at::kFloat8_e4m3fn, false>("FP8", options);
  benchmark<cute::float_e4m3_t, at::kFloat8_e4m3fn, true>("FP8", options);
